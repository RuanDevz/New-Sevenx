...
>
  ...
  <div className="flex flex-wrap items-center gap-2 text-[11px]">
    ...
    {/* NEW */}
    <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md font-semibold bg-purple-600 text-white">
        ...
        <>
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="relative flex items-center justify-center">
              {/* Wave 1 */}
              <span className="absolute w-24 h-24 rounded-full bg-purple-500/30 animate-[ping_2.5s_ease-out_infinite]" />
              
              {/* Wave 2 */}
              <span className="absolute w-32 h-32 rounded-full bg-purple-500/20 animate-[ping_3.2s_ease-out_infinite]" />
